...
gulp.task('compile-scripts', require('./gulp-tasks/compile-scripts')(gulp, paths, environment));
gulp.task('compile-styles', require('./gulp-tasks/compile-styles')(gulp, paths, environment));
gulp.task('replace-environment-variables', require('./gulp-tasks/replace-environment-variables')(gulp, paths, environment, environmentVariables));
gulp.task('server', require('./gulp-tasks/server')(gulp, paths, browserSync));
gulp.task('watch', require('./gulp-tasks/watch')(gulp, paths, browserSync));
